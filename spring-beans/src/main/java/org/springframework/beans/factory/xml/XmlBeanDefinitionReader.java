...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	protected Document doLoadDocument(InputSource inputSource, Resource resource) throws Exception {
		/**
		 * getValidationModeForResource(resource):获取资源文件的验证方法DTD或者XSD
		 * getEntityResolver()获取entityResolver,以便后期调用entityResolver.resolveEntity()方法,返回值:InputSource
		 * entityResolver.resolveEntity()的作用是项目本身就可以提供一个如何寻找DTD声明的方法,即由程序来实现寻找DTD声明的过程
