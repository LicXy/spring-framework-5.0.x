...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public List<BeanFactoryPostProcessor> getBeanFactoryPostProcessors() {
		/**
		 * 返回自定义的beanFactoryPostProcessor, 可以通过调
		 * {@link AbstractApplicationContext#addBeanFactoryPostProcessor} 方法手动添加
		 */
	...
	public Object getBean(String name) throws BeansException {
		...
		/**
		 * getBeanFactory(): {@link GenericApplicationContext#getBeanFactory()}
		 * getBean(): {@link AbstractBeanFactory#getBean(java.lang.String)}
		 */
